...
class ApiContractTest(unittest.TestCase):
    ...
    def test_response_models_are_declared_for_backend_contract(self):
        expected_response_schemas = {
            ...
            "/api/v1/planning/resources/organization-chart/generate": "OrganizationChartGenerationResponse",
            "/api/v1/planning/costs/estimate": "PlanningCostResponse",
            "/api/v1/planning/costs/effort-estimate": "PlanningEffortEstimateResponse",
