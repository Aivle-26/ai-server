...
from app.domains.communication_risk.router import router as communication_risk_router
from app.domains.planning_documents.router import router as planning_documents_router
